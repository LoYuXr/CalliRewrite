...
from hyper_parameters import FLAGS, get_default_hparams_phase_1
...
def trainer(model_params):
    ...
    eval_sample_model_params['batch_size'] = len(eval_sample_model_params['gpus']) * eval_sample_model_params[
        'loop_per_gpu']
...
def main():
    model_params = get_default_hparams_phase_1()
